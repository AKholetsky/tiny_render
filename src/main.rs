...
fn main() {
    ...
    // let mut t0: [Vector2<i32>; 3] = [Vector2::new(10, 70), Vector2::new(50, 160), Vector2::new(70, 80)]; 
    // let mut t1: [Vector2<i32>; 3] = [Vector2::new(180, 50), Vector2::new(150, 1), Vector2::new(70, 180)]; 
    // let mut t2: [Vector2<i32>; 3] = [Vector2::new(180, 150), Vector2::new(120, 160), Vector2::new(130, 180)]; 
...
fn triangle(t0: Vector2<i32>, t1: Vector2<i32>, t2: Vector2<i32>, image: &mut TGAImage, color: TGAColor) {
    let mut t0 = t0;
    let mut t1 = t1;
    let mut t2 = t2;
    let green = TGAColor::rgb(0, 255, 0);
    ...
    for y in t0.y..t1.y {
        ...
        let beta = (y as f32 - t0.y as f32) / segment_height as f32;
        let A = t0 + (t2 - t0) * alpha as i32;
        let B = t0 + (t1 - t0) * beta as i32;
...
fn line(p0: Vector2<i32>, p1: Vector2<i32>, image: &mut TGAImage, color: TGAColor) {
    let mut p0 = p0;
    let mut p1 = p1;
